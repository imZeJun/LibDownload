package com.meitu.mobile.browser.lib.download;
...
import com.meitu.mobile.browser.lib.download.util.FileUtils;
...
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.COLUMN_TITLE;
...
public class DownloadManager {
    ...
    public static class Request {
         ...
         */
        public DownloadManager.Request setDestinationInExternalFilesDir(Context context, String dirType,
                                                                                    String subPath) {
         ...
         * should be called before {@link android.app.DownloadManager#enqueue(android.app.DownloadManager.Request)} is called.
         */
    ...
    public static class Query {
         ...
         * @return this object
         */
        public DownloadManager.Query setFilterByString(@Nullable String filter) {
         ...
         * @return this object
         */
        public DownloadManager.Query setOnlyIncludeVisibleInDownloadsUi(boolean value) {
         ...
         * @return this object
         */
        public DownloadManager.Query orderBy(String column, int direction) {
        ...
        Cursor runQuery(ContentResolver resolver, String[] projection, Uri baseUri) {
            ...
            if (whereArgsCount > 0) {
                ...
                if (mFilterString != null) {
                    selectionParts.add(COLUMN_TITLE + " LIKE ?");
    ...
    public void restartDownload(long... ids) {
        Cursor cursor = query(new DownloadManager.Query().setFilterById(ids));
        try {
    ...
    public static Long getMaxBytesOverMobile(Context context) {
        try {
            return Settings.Global.getLong(context.getContentResolver(),
                    com.meitu.mobile.browser.lib.download.constant.Settings.Global.DOWNLOAD_MAX_BYTES_OVER_MOBILE);
    ...
    public long addCompletedDownload(String title, String description,
        ...
        if (uri != null) {
            ...
            request = new DownloadManager.Request(NON_DOWNLOADMANAGER_DOWNLOAD);
        }
        ...
        values.put(Downloads.Impl.COLUMN_MEDIA_SCANNED,
                (isMediaScannerScannable) ? DownloadManager.Request.SCANNABLE_VALUE_YES :
                        DownloadManager.Request.SCANNABLE_VALUE_NO);
        values.put(Downloads.Impl.COLUMN_VISIBILITY, (showNotification) ?
                android.app.DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_ONLY_COMPLETION : android.app.DownloadManager.Request.VISIBILITY_HIDDEN);
