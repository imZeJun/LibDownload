...
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.COLUMN_CONTROL;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.COLUMN_DELETED;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.COLUMN_STATUS;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.CONTROL_PAUSED;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.STATUS_BAD_REQUEST;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.STATUS_CANCELED;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.STATUS_CANNOT_RESUME;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.STATUS_FILE_ERROR;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.STATUS_HTTP_DATA_ERROR;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.STATUS_PAUSED_BY_APP;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.STATUS_QUEUED_FOR_WIFI;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.STATUS_RUNNING;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.STATUS_SUCCESS;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.STATUS_TOO_MANY_REDIRECTS;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.STATUS_UNHANDLED_HTTP_CODE;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.STATUS_UNKNOWN_ERROR;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.STATUS_WAITING_FOR_NETWORK;
import static com.meitu.mobile.browser.lib.download.constant.Downloads.Impl.STATUS_WAITING_TO_RETRY;
